# Explicit Research Presentation handoff

Research Presentation is outside this skill. Do not bundle it, install it, invoke it,
or require it during ordinary review.

Use the external `research-presentation` skill only after all of the following are
true:
...
Provide only same-review-ID artifacts. Use the security-cleared PDF as the visual
record, the private/evidence artifacts for reasoning, the submission review for the
author-visible assessment, and the venue rubric for score labels.

The presentation must distinguish paper claims, reported results, and reviewer
assessment. It must not add a criticism, strengthen a claim, recalculate a score,
