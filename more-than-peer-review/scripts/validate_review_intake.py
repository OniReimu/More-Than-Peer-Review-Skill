...
def validate_intake(payload: Any) -> dict[str, Any]:
    ...
    if authorization_basis == "not_recorded":
        errors.append(issue("AUTHORIZATION_BASIS_NOT_RECORDED", "authorization.basis"))
    ...
    if capacity == "not_recorded":
        errors.append(issue("REVIEWER_CAPACITY_NOT_RECORDED", "reviewer.capacity"))
    if "not_recorded" in competence_areas:
        errors.append(issue("COMPETENCE_AREAS_NOT_RECORDED", "reviewer.competence_areas"))
    ...
    if manuscript_type == "not_recorded":
        errors.append(issue("MANUSCRIPT_TYPE_NOT_RECORDED", "scope.manuscript_type"))
    if "not_recorded" in requested_focus:
        errors.append(issue("REQUESTED_FOCUS_NOT_RECORDED", "scope.requested_focus"))
